...
{
    internal class CaMay : ARecord
    {
        protected int HMId;
        protected int CVId;
        public CaMay(int CongViecId) : this(CongViecId, 0) { }

        public CaMay(int CongViecId, int HangMucId)
        {
        ...
        public override string Path { get { return "HangMuc." + HMId + ".CongViec." + CVId + ".CaMay." + Id; } }
