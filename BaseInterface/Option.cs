...
namespace BaseInterface
{
    public class Option
    {
        ...
        public static Dictionary<PPTCuocOto, string> DanhSachPPTCuocOto = new Dictionary<PPTCuocOto, string>() {
            ...
            { PPTCuocOto.MauTinhQuangBinh,"mẫu tỉnh Quảng Bình"},
            { PPTCuocOto.TT10, "Theo TT10"},
            { PPTCuocOto.TT12,"Theo TT12"},
            { PPTCuocOto.Theo588, "Theo 588"},
            { PPTCuocOto.QuangNam38_2021,"Quảng Nam 38-2021"},
            { PPTCuocOto.QuangNam24_22022, "Quảng NAm 242-2022"},
        };
    }
