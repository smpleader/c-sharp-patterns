...
using UserEntity = Worksheet.Data.Entities.User.Schema;
using UserSqlite = Worksheet.Data.Entities.User.Sqlite;
using Worksheet.Util;
using Worksheet.Data.Entities.User;
using Worksheet.Data.Entities;
using SqlDrive = Worksheet.Util.Drivers.Sqlite;

namespace Worksheet.DB.SQLite
{
